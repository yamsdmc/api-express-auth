...
describe('LogoutUseCase', () => {
    ...
    it('should handle errors from blacklist service', async () => {
        mockBlacklist.addToBlacklist = vi.fn().mockRejectedValue(new Error('Blacklist error'));
    ...
    it('should handle errors from refresh token repository', async () => {
        mockRefreshTokenRepo.delete = vi.fn().mockRejectedValue(new Error('Repository error'));
